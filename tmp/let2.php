...
//418
$size=intval(418/$_SESSION["zooms"]);
...
echo("<th bgcolor=\"#$farba\"><a onMouseOver=\"info('".$row["xc"]."','".$row["yc"]."','".$row["meno"]."','".$row["utokna"]."','".$row["zivot"]."','".$row["zivotmax"]."','".$row["vlistnik"]."')\" href=\"../../index.php?dir=casti/mapa/policko.php&xc1=".$row["xc"]."&yc1=".$row["yc"]."\" target=\"_parent\"><img src=\"../jednotky/let/mapa/".$row["obrazok"]."/".$rand.".gif\" width=\"$size\" height=\"$size\" border=\"0\"/></th>");
if($row["xc"]-$xc+1 == $zoom){
echo("</tr><tr>");
}
}
...
<br />
<b>vlastník:&nbsp;&nbsp;&nbsp;&nbsp;</b>
<input name="vlastnik" id="vlastnik" size="10" style="border:0px solid #FFFFFF"/>
<br/> 
<b>budova:&nbsp;&nbsp;&nbsp;&nbsp;</b> <input size="10" name="obrazok" style="border:0px solid #FFFFFF"/>  
<br/>   
