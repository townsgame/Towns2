...
zprava($row["kam"],"Suroviny od hráče ".profil($row["od"]),zobrazsur($row["prachy"],$row["jedlo"],$row["kamen"],$row["zelezo"],$row["drevo"]),31415);
...
$nexttime = hnet("towns2_possur","SELECT min(cas) FROM towns2_possur WHERE ".rand(10000,99999));
