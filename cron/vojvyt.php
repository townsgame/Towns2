...
foreach(hnet2("towns2_uziv","SELECT zelezo,id,vojaci,vojacit FROM towns2_uziv WHERE vojacit != '.1(v0,s0,k0,r0,j0,t0,z0,b0,a0,e0,n0,d0,m0)' and vojacit") as $row){
...
surovinanew($row["id"],"zelezo","-",vojakcena($row["vojacit"]));
dc("towns2_uziv");
//echo("<br/>");
}
