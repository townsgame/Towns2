...
-->
        ...
        <div style="position:absolute; left:310px; top:1px; z-index:1;"><a onClick="zmen(0,-10);"></a></div>
		  <div style="position:absolute; left:310px; top:191px; z-index:1;"><a onClick="zmen(10,0);"></a></div>
		  <div style="position:absolute; left:1px; top:191px; z-index:1;"><a onClick="zmen(0,10);"></a></div>
		  </div>
        </div>
        <div align="center">
        <?php
...
$stream = $stream."<form  method=\"post\" action=\"\"> 
<input name=\"meno\" type=\"hidden\" id=\"meno\" />
...
ramcek($stream,"#cccccc");*/
?>
        <div style="left:1000px; top:1000px;" id="mapa">mapa se načítá</div> 
...
<?php
foreach(hnet2("towns2_uni","SELECT meno,obrazok,kamen,drevo FROM towns2_uni WHERE ppp AND akce != '0' AND obrazok != '0' ORDER by meno") as $row){
$ne=0;
//---------------------------------
...
?>
 ...
 | <a onClick="zbourat();"><u>Zbourat</u></a> | <a onClick="roz();"><u>Rozšířit</u></a> | <a onClick="utok();"><u>Útok</u></a> </b><br/>
                ...
                if (ajax.readyState == 4){
                    if(ajax.status == 200 || ajax.status==0){
                        ...
                        for(var i=0;dat1.charAt(i+1);i=i+2){
                            ...
                            x2 = x2+((yc-dyc)*-(vv/2));
                            y2 = y2+((yc-dyc)*(mv/2));
                            x2=x2-((size-1)*(vv/2))+50+(zoom*25);
                            //xc=xc+level;
                            y2=y2-level;
        
        										zi=0;
                            if(level > 0) { zi=1; cash = cash + ("<div style=\"position:absolute; left:"+x2+"px; top:"+(y2/*-vv*size*(1/10)*/)+"px; z-index:2;\"><img border=\"0\" src=\"casti/jednotky/drag/level.php?level="+(level+500)+"&amp;pozadie="+(pozadie)+"\" /></div>"); }
