<?php  
if($_GET["vytrenovat"]){
$odpoved = mysql_query("SELECT napis,budovanas,vlastnik FROM towns WHERE napis != '' AND obrazok = 'kasarny' AND budovanas != '' AND  xc = ".$xc." AND yc = ".$yc);
...
mysql_free_result($odpoved);
echo("cena: ".vojakcena($napis)." železa<br/>");
vojakvloz($napis,"OK");
