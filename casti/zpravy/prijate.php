...
//---------------------------------------------
if($_MYGET["archyv"]){
mysql_query("UPDATE towns2_zpr SET precitane='3' WHERE id='".$_MYGET["archyv"]."' and  komu='".$_SESSION["id"]."'");  
deletecash("towns2_zpr");
}
if($_MYGET["alles"] == 1){
mysql_query("UPDATE towns2_zpr SET precitane='3' WHERE komu='".$_SESSION["id"]."'");  
deletecash("towns2_zpr");
}
if($_MYGET["alles"] == 2){
